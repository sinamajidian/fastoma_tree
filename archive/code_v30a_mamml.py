...
if __name__ == "__main__":
    ...
    # a global variable
    project_folder = "/work/FAC/FBM/DBC/cdessim2/default/smajidi1/fastoma/mammal/old/mml6/"
...
# In[ ]:
    ...
    threshold_least_query_sepecies_in_OG = 97 # 15

    kept_oma_species_num = 8 # 20
    ...
    number_max_workers = 4 # round(int(argv[3])*1.3)
